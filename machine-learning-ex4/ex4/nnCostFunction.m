...
val = (-output).*log(a3)-(1-output).*log(1-a3) ;
J=((1/m).*sum(sum(val))); 
...
% Part 2 : Implementing backprpagatin algo
% -------------------------------------------------------------
...
delta2=delta2(:,2:end);
tridelta1=delta2'*X; % Same size as Theta1_grad (25x401)
tridelta2=delta3'*a2; % Same size as Theta2_grad (10x26)
